...
Als Datenbasis wurde eine Auswahl von fünf exemplarischen CAP-Anwendungen herangezogen. Diese Anzahl ergibt sich aus den im Rahmen dieser Ausarbeitung zur Verfügung stehenden, relevanten Projekten. Vier davon - *CAP-SFlight*, *CAP-Orders*, *CAP-Reviews* sowie *CAP-Bookshop* - sind öffentlich verfügbare Schulungsanwendungen von SAP. Diese wurden aufgrund ihrer einfachen und übersichtlichen Struktur, des erleichterten Zugriffs sowie der öffentlichen Validierung ihrer Funktionsfähigkeit als primäre Testfälle für den KI-Agenten gewählt. Die Auswahl dieser grundlegenden Anwendungsfälle soll zunächst sicherstellen, dass der Agent die Standardkonfigurationen von CAP-Projekten korrekt verarbeiten kann, bevor er mit komplexeren, nicht-standardisierten Repositories konfrontiert wird.
